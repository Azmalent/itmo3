...
; Написать программу на языке ассемблера,  в которой задаётся моделируемый массив.  
; В двоичном представлении элемента массива результата единицами заполняется столько младших  разрядов, сколько единиц содержится в двоичном
; представлении соответствующего элемента исходного массива. Остальные разряды заполняются нулями.   
...
data segment para public 'data'	
	...
	; array dd 11111111111111111111110000000000b, 00000000000011111111111111111111b, 
			 ; 11000000000000000000000011111111b, 11111111111111000000000000000000b, 
			 ; 00001111111111111111111111000000b, 00000000000000001111111111111111b, 
			 ; 11111100000000000000000000001111b, 11111111111111111100000000000000b, 
			 ; 00000000111111111111111111111100b, 00000000000000000000111111111111b, 
...
;	EBX = элемент
;	CX = счётчик цикла
countSetBits macro array:=<array>
